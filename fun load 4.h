...
int funload4 (int n,int m,int i0,int rem ,int u,int mode,int turnco,player p1,player p2,char colour1[20],char colour2[20],
...
//game loud
    ...
    if(mode==2&&turnco==0) {
        if (strcmp(colour1, "red") == 0 && strcmp(colour2, "green") == 0) {
        ...
        else if (strcmp(colour1, "magenta") == 0 && strcmp(colour2, "red") == 0) {
